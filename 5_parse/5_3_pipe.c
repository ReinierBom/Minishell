...
/*   Updated: 2024/10/02 17:22:22 by rbom          ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
/* LENGTH PIPE */
static size_t	len_pipe(t_cmdl *cmdl, t_cmd *cmd, size_t pipe, size_t start)
{
	size_t	len;
	size_t	quote;
...
/* COPIES PIPE */
static void	copy_pipe(t_cmdl *cmdl, t_cmd *cmd, size_t pipe, size_t start)
{
	size_t	len;
	size_t	quote;
